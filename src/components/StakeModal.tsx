...
const styles = StyleSheet.create({
  ...
  quickAmt:          { flex: 1, backgroundColor: COLORS.surfaceAlt, borderRadius: 99, paddingVertical: 8, alignItems: 'center', borderWidth: 1, borderColor: COLORS.border },
  quickAmtText:      { fontFamily: FONTS.sansMedium, color: COLORS.text, fontSize: 13 },
  amountInput:       { backgroundColor: COLORS.surfaceAlt, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border, padding: 12, fontFamily: FONTS.sans, color: COLORS.text, fontSize: 16, marginBottom: 14 },
  preview:           { backgroundColor: COLORS.primaryLight, borderRadius: 14, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: COLORS.primary + '33' },
